  ...
  var makeJsonMenu = function(currentDocsObject){
      if (currentDocsObject.config.saveJsonMenu){
          ...
          var giveChildren = _.each(allParents,function(o){
              ...
              // If the child a larger array by 1 or more than the parent,
...
// self.log('using mdFileName:',mdFileName)
                      var newFile = {
                        templateConfig: {},
                      ...
                      var mdKey = key+'.md';
                      // console.log('looking for mdKey:',mdKey,'in ',currentDirectoryObject[key])
                      try {
