    ...
    var doSectionSplit = function(docSectionObject, emitFile) {
      ...
      splitFiles.forEach(function(v, i) {
        ...
        if (i === 0) {
          ...
          currentDocsObject.populatedSections[sectionName] = [];
          currentDocsObject.config.jsonMenu[sectionName] = {name:sectionName,contents:[]};
        ...
        currentDocsObject.populatedSections[sectionName].push(newFile);
